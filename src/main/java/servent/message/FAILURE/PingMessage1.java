...
public class PingMessage1 extends BasicMessage {
    ...
    public PingMessage1(int senderPort, int receiverPort, int originalSenderID, int originalReciverID, PingType type) {
