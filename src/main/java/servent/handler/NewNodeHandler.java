	...
	public void run() {
		if (clientMessage.getMessageType() == MessageType.NEW_NODE) {
			...
			if (AppConfig.chordState.isCollision(newNodeInfo.getChordId())) {
				Message sry = new SorryMessage(AppConfig.myServentInfo.getListenerPort(), clientMessage.getSenderPort(),AppConfig.myServentInfo.getChordId(), newNodeInfo.getChordId());
			...
			if (isMyPred) { //if yes, prepare and send welcome message
				...
				WelcomeMessage wm = new WelcomeMessage(AppConfig.myServentInfo.getListenerPort(), newNodePort, hisValues,AppConfig.myServentInfo.getChordId(), newNodeInfo.getChordId());
				...
				NewNodeMessage nnm = new NewNodeMessage(newNodePort, nextNode.getListenerPort(),AppConfig.myServentInfo.getChordId(), newNodeInfo.getChordId());
